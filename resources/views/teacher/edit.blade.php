                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 md:col-span-12 xl:col-span-12">
                            <form method="POST" action="{{ url('teacher/'.$teacher->id) }}" onsubmit="return validateForm()">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="relative mb-6" >
                                    ...
                                    @foreach($departments as $department)
                                        <option value="{{$department->id}}" {{ $department->id == $teacher->department_id ? 'selected':''}}>{{$department->code.'-'.$department->name}}</option>
                                ...
                                @enderror
                                <label data-te-select-label-ref>Select Department</label>
                                </div>

                                <div class="relative mb-6" data-te-input-wrapper-init>
                                <input
                                    type="text"
                                    class="@error('emp_code') is-invalid @enderror peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    id="emp_code"
                                    name="emp_code"
                                ...
                                <select data-te-select-init
                                    class="@error('name_prefix') is-invalid @enderror peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    id="name_prefix"
                                    name="name_prefix"
                                    placeholder="Department"
                                    value="{{$teacher->name_prefix}}"
                                    required
                                
                                >
                                <option value="" hidden selected></option>
                                <option value="Mr." {{$teacher->name_prefix == "Mr." ? "selected":""}}>Mr.</option>
                                <option value="Mrs." {{$teacher->name_prefix == "Mrs." ? "selected":""}}>Mrs.</option>
                                <option value="Miss." {{$teacher->name_prefix == "Miss." ? "selected":""}}>Miss.</option>
                                <option value="Ms." {{$teacher->name_prefix == "Ms." ? "selected":""}}>Ms.</option>
                                <option value="Dr." {{$teacher->name_prefix == "Dr." ? "selected":""}}>Dr.</option>
                                <option value="Prof." {{$teacher->name_prefix == "Prof." ? "selected":""}}>Prof.</option>
                                ...
                                @enderror
                                <label data-te-select-label-ref>Select Name Prefix</label>
                                </div>
                                ...
                                <input
                                    type="text"
                                    class="@error('name') is-invalid @enderror peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    id="name"
                                    name="name"
                                    placeholder="Name" 
                                    required
                                ...
                                <input
                                    type="email"
                                    class="@error('email') is-invalid @enderror peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    id="email"
                                    name="email"
                                    placeholder="email" 
                                    value="{{$teacher->email}}"
                                ...
                                <input
                                    type="number"
                                    class="@error('mobile1') is-invalid @enderror peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    id="mobile1"
                                    name="mobile1"
                                    placeholder="mobile1" 
                                    required
                                    value="{{$teacher->mobile1}}"
                                    />
                                @error('mobile1')
                                <div
                                    class="absolute w-full text-sm text-neutral-500 peer-focus:text-primary dark:text-neutral-200 dark:peer-focus:text-primary"
                                ...
                                <input
                                    type="number"
                                    class="@error('mobile2') is-invalid @enderror peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    id="mobile2"
                                    name="mobile2"
                                    placeholder="mobile2" 
                                    required
                                    value="{{$teacher->mobile2}}"
                                    />
                                @error('mobile2')
                                <div
                                    class="absolute w-full text-sm text-neutral-500 peer-focus:text-primary dark:text-neutral-200 dark:peer-focus:text-primary"
                                ...
                                <input
                                    type="text"
                                    class="@error('addr1') is-invalid @enderror peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    id="addr1"
                                    name="addr1"
                                    placeholder="addr1" 
                                    required
                                ...
                                <input
                                    type="text"
                                    class="@error('addr2') is-invalid @enderror peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    id="addr2"
                                    name="addr2"
                                    placeholder="addr2"
                                    value="{{$teacher->addr2}}" 
                                ...
                                <div class="relative mb-6" >
                                    ...
                                    <select data-te-select-init data-te-select-filter="true"
                                    class="@error('city_id') is-invalid @enderror peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    id="city_id"
                                    name="city_id"
                                    placeholder="City"
                                    >
                                    ...
                                    @foreach($cities as $city)
                                        <option value="{{$city->city_id}}" {{$city->city_id == $teacher->city_id?'selected':''}}>{{$city->city_name.', '.$city->district->district_name.', '.$city->state->state_name}}</option>
                                ...
                                @enderror
                                <label data-te-select-label-ref>Select City</label>
                                </div>
