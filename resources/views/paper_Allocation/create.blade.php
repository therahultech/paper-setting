                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 md:col-span-12 xl:col-span-12">
                            <form method="POST" action="{{ url('paper_Allocation') }}">
                                @csrf
                                ...
                                <div class="relative mb-6" >
                                    ...
                                    @foreach($papers as $paper)
                                        <option value="{{$paper->id}}">{{$paper->exam_paper_id.':'.$paper->subject->code.'-'.$paper->subject->name}}</option>
                                ...
                                <div class="relative mb-6" >
                                    ...
                                    @foreach($teachers as $teacher)
                                        <option value="{{$teacher->id}}">{{$teacher->name_prefix.' '.$teacher->name.'('.$teacher->department->code.'-'.$teacher->department->name.')'}}</option>
