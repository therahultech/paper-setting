<x-guest-layout>
    ...
    <div class="container h-full px-6 py-24 items-center justify-center">
        <div
        class="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
        <!-- Left column container with background-->
        <div class="mb- md:mb-0 md:w-8/12 lg:w-6/12">
            <center><img
            src="{{ asset('images/logo.png') }}"
            class="md:w-4/12 lg:w-4/12 sm:w-full"
            alt="Guru Jambheshwar University of Science & Technology" style="width: fit-content;"/>
            <h3 class="text-2xl font-medium leading-tight">Guru Jambheshwar University of Science & Technology</h3>
            </center>
