                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 md:col-span-12 xl:col-span-12">
                            <form method="POST" action="{{ url('subject/'.$subject->id) }}" onsubmit="return validateForm()">
                                @csrf
                                @method('PUT')
                                ...
                                class="mb-6 flex min-h-[1.5rem] pl-[1.5rem]">
                                    <input type="hidden" name="is_credit_based" value="0" />
                                    <input
                                        ...
                                        type="checkbox"
                                        value="1"
                                        name="is_credit_based"
                                        id="is_credit_based" 
                                        {{$subject->is_credit_based?'checked':''}}
                                        />
                                    <label
