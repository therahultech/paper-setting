                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 md:col-span-12 xl:col-span-12">
                            <form method="POST" action="{{ url('course/'.$course->id) }}" onsubmit="return validateForm()">
                                @csrf
                                @method('PUT')
                                ...
                                class="mb-6 flex min-h-[1.5rem] pl-[1.5rem]">
                                    <input type="hidden" name="is_year_based" value="0" />
                                    <input
                                ...
                                <input
                                    type="number"
                                    class="@error('duration') is-invalid @enderror peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    id="duration"
                                    name="duration"
