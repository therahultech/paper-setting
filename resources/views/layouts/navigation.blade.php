<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('paper_Upload.index')" :active="request()->routeIs('paper_Upload.*')">
                        {{ __('Paper Upload') }}
                    </x-nav-link>
                </div>
                @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('paper_Allocation.index')" :active="request()->routeIs('paper_Allocation.*')">
                {{ __('Paper Allocation') }}
            </x-responsive-nav-link>
        </div>  
        @endif 
        @if(Auth::user()->hasAnyRole(['Super_Admin','Teacher'])) 
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('paper_Upload.index')" :active="request()->routeIs('paper_Upload.*')">
                {{ __('Paper Upload') }}
            </x-responsive-nav-link>
        </div> 
        @endif   
