    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 light:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex items-top justify-center pt-8 sm:justify-start sm:pt-0">
                    <img src="{{ asset('images/logo.png') }}" alt="GJUST LOGO" srcset="" width="100" height="100">
                    <h1 style='margin-left:20px;'>Guru Jambheshear University of Science & Technology</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6 border-t border-gray-200 light:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="" class="underline text-gray-900 light:text-white">Notifications</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 light:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 light:text-white">News</div>
                            </div>
