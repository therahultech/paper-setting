                            ...
                            <table class="min-w-full text-left text-sm font-light nowrap" id='view_table' style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-neutral-500">
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4">{{$dept->status}}</td>
                                        <td class="whitespace-nowrap px-6 py-4"><a href="#"><i class="fa-solid fa-pen-to-square px-4"></i></a> <a href="#"><i class="fa-solid fa-trash px-4"></i></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>   
